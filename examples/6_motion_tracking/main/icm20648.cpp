...
const static gpio_num_t GPIO_VSPI_CS = GPIO_NUM_5;
const static gpio_num_t GPIO_VSPI_SCLK = GPIO_NUM_18;
const static gpio_num_t GPIO_VSPI_MOSI = GPIO_NUM_19;
const static gpio_num_t GPIO_VSPI_MISO = GPIO_NUM_21;
